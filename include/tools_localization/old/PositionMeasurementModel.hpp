#ifndef KALMANFILTER1_POSITIONMEASUREMENTMODEL_HPP_
#define KALMANFILTER1_POSITIONMEASUREMENTMODEL_HPP_
...
public:
    ...
    typedef  Kalman::Filter1::State<T> S;
    
    //! Measurement type shortcut definition
    typedef  Kalman::Filter1::PositionMeasurement<T> M;
     ...
     */
    PositionMeasurementModel(T landmark1x, T landmark1y)
    {
